...
-- Improved auto-kill all feature (corrigido)
            ...
            while _G.autoKillAll do
                pcall(function()
                    ...
                    for _, plr in ipairs(players) do
                        -- pula o local player ou se a função foi desligada
                        if plr == game.Players.LocalPlayer or not _G.autoKillAll then
                            -- skip
                        else
                            -- Check if player is whitelisted
                            local isWhitelisted = false
                            for _, whitelistedInfo in ipairs(_G.whitelistedPlayers or {}) do
                                if whitelistedInfo:find(plr.Name, 1, true) then
                                    isWhitelisted = true
                                    break
                                end
                            end
...
noteTab:AddLabel("Chefaottv Script")
...
noteTab:AddLabel("criado por: marmortabw")
noteTab:AddLabel("caso queria ter um, chame no discord acima!")